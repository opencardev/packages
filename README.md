...
|---------------|----------|---------|
| Ubuntu 24.04  | noble    | ✅ Active (components: stable, nightly) |
...
- **Multi-Distribution**: Separate repositories for Noble (Ubuntu 24.04), Trixie, and Bookworm
...
# Test repository metadata (replace 'trixie' with your distribution: trixie, bookworm, noble)
curl -s https://apt.opencardev.org/dists/trixie/Release
curl -s https://apt.opencardev.org/dists/noble/Release

# Check available packages
curl -s https://apt.opencardev.org/dists/trixie/main/binary-amd64/Packages
curl -s https://apt.opencardev.org/dists/noble/main/binary-amd64/Packages
```
